...
print(lipo_akku)
print(lipo_results[["time", "engine_current", "battery_soc_percent", "battery_voltage"]].tail())

print("\nNMC Akku nach der Strecke:")
print(nmc_akku)
print(nmc_results[["time", "engine_current", "battery_soc_percent", "battery_voltage"]].tail())
